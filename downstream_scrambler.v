module lfsr_downstream_8p (
    ...
    always @(*) begin
        case (Spg)
            3'd1, 3'd2:       spg_gate = 1'b1; 
            3'd3, 3'd4, 3'd5: spg_gate = 1'b0; 
    ...
    assign data_xor_s0[0] = data_in[7] ^ s0[0]; 
    assign data_xor_s0[1] = data_in[6] ^ s0[1]; 
    assign data_xor_s0[2] = data_in[5] ^ s0[2]; 
    assign data_xor_s0[3] = data_in[4] ^ s0[3]; 
    assign data_xor_s0[4] = data_in[3] ^ s0[4]; 
    assign data_xor_s0[5] = data_in[2] ^ s0[5]; 
    assign data_xor_s0[6] = data_in[1] ^ s0[6]; 
    assign data_xor_s0[7] = data_in[0] ^ s0[7]; 
